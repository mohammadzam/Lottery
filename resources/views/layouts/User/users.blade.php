        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-left mb-4">
                    <a  href="{{route('create.new.user')}}" class="btn btn-primary px-4">Create New User</a>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>{{$datum->name}}</td>
                                        <td>{{$datum->email}}</td>
                                        @if($datum->is_winner == 1)
                                            <td class="text-success"> Already won At <br> {{$datum->updated_at}}</td>
                                        @else
                                            <td class="text-danger">He hasn't won yet</td>
                                        @endif

                                        <td class="d-flex justify-content-around">
                                            <a href="{{route('show.edit.form.user',$datum->id)}}">
                                                <i class="las la-pen text-info font-18"></i>
                                            </a>
                                            <a href="#">
                                                <i class="las la-eye text-success font-18"></i>
                                            </a>
                                            <a href="{{route('destroy.user',$datum->id)}}">
